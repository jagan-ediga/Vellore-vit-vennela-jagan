...
document.querySelector(".sidebar-container .logo-section a").setAttribute("tabIndex", sidebarOpening ? 0 : -1);
};
const openSidebar = function () {
    sidebarContainer.classList.add ("show-sidebar"); updateAccessiblityChecks(true);
};
